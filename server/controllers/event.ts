...
async function createEvent(req: Request, res: Response) {
  try {
    console.log('in createEvent server isde')
    ...
    //   } else {
    console.log("req.body of event", req.body)
    const { name, address, date, description, tokensNumber, img_url, tokensValue, artistId } = req.body;
    const _event = await Event.create({ name: name, address: address, date: date, description: description, number_of_tokens: tokensNumber, tokens_image: img_url, tokens_value: tokensValue });
