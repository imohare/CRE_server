...
import { Vector3, Vector2, Vector4, Matrix3, Matrix4, Color as Color$2, Texture as Texture$2, MathUtils, TextureLoader } from 'three';
...
const DebugLayerMaterial = /*#__PURE__*/React.forwardRef(({
  ...
  const {
    ...
    Color: {
      value: '#' + new Color$2(((_ref$current = ref.current) == null ? void 0 : _ref$current.baseColor) || (props == null ? void 0 : props.color) || 'white').getHexString(),
      onChange: v => {
  ...
  React.useLayoutEffect(() => {
    ...
    if (root) {
      ...
      ReactDOM.render( /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement(LevaPanel, {
        titleBar: {
