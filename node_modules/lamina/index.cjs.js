...
const DebugLayerMaterial = /*#__PURE__*/React__default["default"].forwardRef(({
  ...
  const {
    ...
    Color: {
      value: '#' + new THREE.Color(((_ref$current = ref.current) == null ? void 0 : _ref$current.baseColor) || (props == null ? void 0 : props.color) || 'white').getHexString(),
      onChange: v => {
  ...
  React__default["default"].useLayoutEffect(() => {
    ...
    if (root) {
      ...
      ReactDOM__default["default"].render( /*#__PURE__*/ReactDOM__default["default"].createPortal( /*#__PURE__*/React__default["default"].createElement(leva.LevaPanel, {
        titleBar: {
