...
var index = /*#__PURE__*/React.forwardRef(({
  ...
  const material = React.useMemo(() => new CustomShaderMaterial(baseMaterial, fragmentShader, vertexShader, uniforms), [baseMaterial, fragmentShader, vertexShader, uniforms]);
